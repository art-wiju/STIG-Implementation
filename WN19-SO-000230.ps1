<#
.SYNOPSIS
    This PowerShell script blocks anonymous enumeration of shares. Allowing anonymous logon users (null session connections) to list all account names and enumerate (perform reconnaissance) all shared resources can provide a map of potential points to attack the system.
